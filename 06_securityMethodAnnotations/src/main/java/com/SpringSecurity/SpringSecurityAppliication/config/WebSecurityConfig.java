...
public class WebSecurityConfig {
        ...
        SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
                ...
                // .formLogin(Customizer.withDefaults()); // this will create a html login form
                // by default but we don't need it on backend bcz it's a duty of frontend to
                // create login page for us
